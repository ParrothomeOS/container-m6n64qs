...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-m6n64qs.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-m6n64qs.containers.anotherwebservice.com/
...
```
git clone git@github.com:ParrothomeOS/container-m6n64qs.git
cd container-m6n64qs
```
...
```
docker attach container-m6n64qs
```
